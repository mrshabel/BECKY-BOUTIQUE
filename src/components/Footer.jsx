export default function Footer() {
  return (
    <section className="bg-black bg-opacity-95 text-gray-400 px-12 md:px-28 py-8 font-light ">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-24 pb-5 border-b-gray-400 border-b">
        <div>
          <h1 className="font-bold uppercase text-xl mb-3 text-center text-gray-50">
            beckys Boutique
          </h1>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-[14px] tracking-wider">
            <p className="">
